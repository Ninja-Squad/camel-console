...
public class StatisticTest {
    ...
    public void computeAverageTruncate() throws Exception {
        ...
        assertThat(statistic).isEqualTo(new Statistic(1000L, TimeUnit.SECOND, 0, 11, 10, 104, 54));
    }
    ...
    public void updateMin() throws Exception {
        ...
        assertThat(statistic).isEqualTo(new Statistic(1000L, TimeUnit.SECOND, 0, 11, 4, 100, 45));
    }
