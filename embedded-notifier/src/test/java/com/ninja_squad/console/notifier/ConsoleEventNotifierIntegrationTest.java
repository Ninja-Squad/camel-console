...
public class ConsoleEventNotifierIntegrationTest {
    ...
    @Test
    public void notifyShouldHandleExchangeEvents() throws Exception {
        startCamelApp();
        ...
        verify(notifier, timeout(1000).times(3)).traceExchange(any(ProcessorDefinition.class),
